...
export const sendOtpEmail = async (email, otp) => {
    const mailOptions = {
        from: `"XConnect" <${process.env.EMAIL_USER}>`,
        to: email,
        subject: "XConnect — Verify Your Email",
        html: `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                    ...
                    <tr>
                        <td style="background-color:#0A2342; padding:30px; text-align:center;">
                            <h1 style="margin:0; color:#ffffff; font-size:28px; 
                                       letter-spacing:1px;">XConnect</h1>
                    ...
                    <tr>
                        <td style="padding:40px 40px 20px 40px;">
                            ...
                            <p style="color:#64748B; line-height:1.7; margin:0 0 28px 0;">
                                Thank you for registering with XConnect. 
                                ...
                                <tr>
                                    <td style="background:#fff8f0; border-left:4px solid #F97316; 
                                        ...
                                        <p style="margin:0; color:#333; font-size:13px; 
                                            ...
                                            XConnect will never ask for your OTP via call or message.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="background:#f8f9fa; padding:20px; 
                            ...
                            <p style="margin:0; color:#94a3b8; font-size:12px;">
                                © 2026 XConnect. All rights reserved.
                            </p>
